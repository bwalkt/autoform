...
import { Text, Heading, Em, Strong, Code, Quote, Blockquote } from "../elements";
...
export const Showcase: Story = {
  ...
  render: () => (
    <div className="space-y-8 max-w-2xl">
      <div>
        <Heading mb="2" size="6">Typography Showcase</Heading>
      ...
      <div>
        <Heading mb="2" size="4">Headings</Heading>
      ...
      <div>
        <Heading mb="2" size="4">Text Sizes</Heading>
        <div className="space-y-2">
      ...
      <div>
        <Heading mb="2" size="4">Weights</Heading>
        <div className="space-y-1">
          <Text size="3" weight="light">Light weight text</Text>
          <Text size="3" weight="regular">Regular weight text</Text>
          <Text size="3" weight="medium">Medium weight text</Text>
          <Text size="3" weight="bold">Bold weight text</Text>
        </div>
      </div>

      <div>
        <Heading mb="2" size="4">Colors</Heading>
        <div className="space-y-1">
      ...
      <div>
        <Heading mb="2" size="4">Inline Elements</Heading>
        <Text size="3">
          The <Em>most</Em> important thing to remember is{" "}
          <Strong>stay positive</Strong>. Use <Code>inline code</Code> when needed.
        </Text>
      </div>

      <div>
        <Heading mb="2" size="4">Code Examples</Heading>
        <div className="space-y-2">
      ...
      <div>
        <Heading mb="2" size="4">Inline Quotes</Heading>
        <Text size="3">
          As Massimo Vignelli said, <Quote>Styles come and go. Good design is a language, not a style</Quote>, which elegantly sums up his philosophy.
        </Text>
      </div>

      <div>
        <Heading mb="2" size="4">Blockquotes</Heading>
        <Blockquote size="3">
      ...
      <div>
        ...
        <Text size="3">
          The <Em>most</Em> important thing to remember is{" "}
          <Strong>stay positive</Strong>. Typography should enhance readability
          and create visual hierarchy. Use consistent spacing and alignment
