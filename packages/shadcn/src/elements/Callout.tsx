...
const CalloutContext = React.createContext<CalloutContextValue>({ size: "md" });

// Size token mappings
const sizeStyles: Record<Size, { padding: string; radius: string; gap: string; iconSize: string }> = {
  xs: { padding: "0.5rem", radius: "0.25rem", gap: "0.5rem", iconSize: "0.875rem" },
  sm: { padding: "0.75rem", radius: "0.375rem", gap: "0.5rem", iconSize: "1rem" },
  md: { padding: "1rem", radius: "0.5rem", gap: "0.75rem", iconSize: "1.125rem" },
  lg: { padding: "1.25rem", radius: "0.625rem", gap: "1rem", iconSize: "1.25rem" },
};
