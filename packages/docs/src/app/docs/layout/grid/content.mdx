...
<CodeBlock.Root style={{ marginTop: 24 }}>
  ...
  <CodeBlock.Content>
    <CodeBlock.Pre>
      <CodeBlock.Code language="jsx">{`<Grid columns="3" gap="3" rows="repeat(2, 64px)" width="auto">
  <DecorativeBox />
  <DecorativeBox />
  <DecorativeBox />
  <DecorativeBox />
...
<CodeBlock.Root style={{ marginTop: 24 }}>
  ...
  <CodeBlock.Content>
    <CodeBlock.Pre>
      <CodeBlock.Code language="jsx">{`<Grid columns={{ initial: "1", md: "2" }} gap="3" width="auto">
  <Box height="64px">
    <DecorativeBox />
  </Box>
  <Box height="64px">
