...
import { type TypographyColor, type TypographySize, typographyTokens } from './tokens'
    ...
    return (
      <code
        ...
        className={cn(
          ...
          // Variant styles
          variant === 'solid' && ['bg-gray-900 text-gray-50', 'border-gray-900'],
          variant === 'soft' && [
          ...
          variant === 'outline' && ['border-gray-300 bg-transparent', 'dark:border-gray-600'],
