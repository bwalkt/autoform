...
const colorStyles: Record<Color, { solid: string; soft: string; outline: string }> = {
  default: {
    solid:
      'data-[checked]:bg-gray-900 data-[checked]:border-transparent dark:data-[checked]:bg-gray-100 dark:data-[checked]:border-transparent',
  ...
  neutral: {
    solid:
      'data-[checked]:bg-gray-500 data-[checked]:border-transparent data-[checked]:text-white dark:data-[checked]:bg-gray-400 dark:data-[checked]:text-gray-900',
  ...
  (
    ...
    return (
      <CheckboxPrimitive.Root
        ...
        {...props}
      >
        <CheckboxPrimitive.Indicator className="flex items-center justify-center text-inherit" style={indicatorStyles}>
          {indeterminate ? (
