  ...
  render: () => {
    ...
    return (
      <div className="w-[400px]">
        <CalendarWithPricing value={date} onChange={setDate} prices={prices} />
        {date && (
  ...
  render: () => {
    ...
    return (
      <div className="w-[400px]">
        ...
        <CalendarWithPricing value={date} onChange={setDate} prices={prices} currency="$" />
...
export const WithMinMaxDate: Story = {
  render: () => {
    ...
    return (
      <div className="w-[400px]">
        <CalendarWithPricing value={date} onChange={setDate} prices={prices} minDate={minDate} maxDate={maxDate} />
...
export const WeekStartsMonday: Story = {
  render: () => {
    ...
    return (
      <div className="w-[400px]">
        <CalendarWithPricing value={date} onChange={setDate} prices={prices} weekStartsOn={1} />
      </div>
    )
  },
}
...
export const Disabled: Story = {
  render: () => {
    ...
    return (
      <div className="w-[400px]">
        <CalendarWithPricing value={today} prices={prices} disabled />
      </div>
    )
  },
}
