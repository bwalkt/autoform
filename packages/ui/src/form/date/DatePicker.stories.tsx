...
export const CustomFormat: Story = {
  render: () => {
    ...
    return (
      <div className="w-[280px]">
        <DatePicker value={date} onChange={setDate} dateFormat="dd/MM/yyyy" placeholder="DD/MM/YYYY" />
      </div>
    )
  },
}
...
export const WithDisabledDates: Story = {
  render: () => {
    ...
    return (
      <div className="w-[280px]">
        <DatePicker value={date} onChange={setDate} disabledDates={disabledDates} placeholder="Some dates disabled" />
      </div>
    )
  },
}
  ...
  render: () => {
    ...
    return (
      <div className="w-[280px] space-y-2">
        <DatePicker value={date} onChange={setDate} enableNaturalLanguage placeholder="Tomorrow or next week" />
        {date && (
...
export const NaturalLanguageWithValue: Story = {
  render: () => {
    ...
    return (
      <div className="w-[280px] space-y-2">
        <DatePicker value={date} onChange={setDate} enableNaturalLanguage placeholder="Type a date..." />
        {date && (
          <p className="text-sm text-muted-foreground px-1">
            Selected: <span className="font-medium">{date.toLocaleDateString()}</span>
          </p>
