...
const meta: Meta<typeof SwitchGroup.Root> = {
  ...
  argTypes: {
    size: {
      control: 'select',
      options: ['1', '2', '3', '4'],
      description: 'The size of all switches',
    },
    variant: {
      control: 'select',
  ...
  render: () => {
    ...
    return (
      <div className="w-96 p-6 border rounded-lg space-y-6">
        ...
        <SwitchGroup.Root value={settings} onValueChange={setSettings} color="success" size="2">
  ...
  render: () => {
    ...
    return (
      <div className="w-96 p-6 border rounded-lg space-y-6">
        ...
        <SwitchGroup.Root value={privacy} onValueChange={setPrivacy} color="primary" size="3">
          <SwitchGroup.Item
            name="analytics"
