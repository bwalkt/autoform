...
const colorStyles: Record<Color, string> = {
  ...
  neutral:
    'peer-data-[checked]:border-gray-500 peer-data-[checked]:bg-gray-500/5 dark:peer-data-[checked]:border-gray-400',
...
const checkboxColorStyles: Record<Color, string> = {
  ...
  neutral:
    'data-[checked]:bg-gray-500 data-[checked]:border-gray-500 dark:data-[checked]:bg-gray-400 dark:data-[checked]:border-gray-400',
      ...
      >
        ...
        >
          <CheckboxPrimitive.Indicator
            className={cn('flex items-center justify-center text-inherit', sizeConfig.checkIcon)}
          >
        ...
        <span
          className={cn(
            ...
            context.variant === 'surface' && [
              ...
              !isDisabled &&
                'group-hover:border-gray-300 group-hover:bg-gray-50 dark:group-hover:border-gray-700 dark:group-hover:bg-gray-800/50',
            ],
        ...
        <div className={cn('relative z-10 flex flex-1 flex-col', sizeConfig.text)}>{children}</div>
      </label>
    )
  },
)
