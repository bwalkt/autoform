  ...
  render: () => (
    <Box display="flex" className="flex-col gap-8">
      <div>
        ...
        <RadioCards.Root size="1" columns={3} defaultValue="a">
      ...
      <div>
        ...
        <RadioCards.Root size="2" columns={3} defaultValue="a">
          <RadioCards.Item value="a">
            <div className="font-medium">Option A</div>
          </RadioCards.Item>
          <RadioCards.Item value="b">
      ...
      <div>
        ...
        <RadioCards.Root size="3" columns={3} defaultValue="a">
          <RadioCards.Item value="a">
            <div className="font-medium">Option A</div>
          </RadioCards.Item>
          <RadioCards.Item value="b">
      ...
      <div>
        ...
        <RadioCards.Root size="4" columns={3} defaultValue="a">
          <RadioCards.Item value="a">
            <div className="font-medium">Option A</div>
          </RadioCards.Item>
          <RadioCards.Item value="b">
  ...
  render: () => {
    ...
    return (
      <div className="max-w-3xl space-y-6">
        ...
        <RadioCards.Root value={plan} onValueChange={setPlan} columns={3} gap="4" color="primary" size="3">
          {plans.map(p => (
