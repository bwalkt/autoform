...
import type { Color, Radius, Responsive, Size, Variant } from './tokens'
...
const variantStyles: Record<Variant, string> = {
  ...
  solid: cn('bg-primary text-primary-foreground', 'hover:bg-primary/90', 'active:bg-primary/80'),
  soft: cn('bg-secondary text-secondary-foreground', 'hover:bg-secondary/80', 'active:bg-secondary/70'),
  surface: cn('bg-background border border-input text-foreground shadow-sm', 'hover:bg-accent/50', 'active:bg-accent'),
  outline: cn(
    'border border-input bg-background',
    'hover:bg-accent hover:text-accent-foreground',
    'active:bg-accent/80',
  ),
  ghost: cn('bg-transparent', 'hover:bg-accent hover:text-accent-foreground', 'active:bg-accent/80'),
}

const colorStyles: Record<Color, Record<Variant, string>> = {
  default: {
    classic:
      'bg-gradient-to-b from-primary/90 to-primary text-primary-foreground shadow-sm hover:from-primary/80 hover:to-primary/95',
  ...
  neutral: {
    classic:
      'bg-gradient-to-b from-gray-400 to-gray-500 text-white shadow-sm hover:from-gray-300 hover:to-gray-400 dark:from-gray-500 dark:to-gray-600',
  ...
  info: {
    ...
    surface:
      'bg-blue-50 border border-blue-200 text-blue-700 shadow-sm hover:bg-blue-100 dark:bg-blue-900/20 dark:border-blue-800 dark:text-blue-400',
  ...
  success: {
    classic:
      'bg-gradient-to-b from-green-500 to-green-600 text-white shadow-sm hover:from-green-400 hover:to-green-500',
    solid: 'bg-green-600 text-white hover:bg-green-700',
    soft: 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400',
    surface:
      'bg-green-50 border border-green-200 text-green-700 shadow-sm hover:bg-green-100 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400',
  ...
  warning: {
    classic:
      'bg-gradient-to-b from-amber-400 to-amber-500 text-white shadow-sm hover:from-amber-300 hover:to-amber-400',
    ...
    surface:
      'bg-amber-50 border border-amber-200 text-amber-700 shadow-sm hover:bg-amber-100 dark:bg-amber-900/20 dark:border-amber-800 dark:text-amber-400',
  ...
  error: {
    ...
    surface:
      'bg-red-50 border border-red-200 text-red-700 shadow-sm hover:bg-red-100 dark:bg-red-900/20 dark:border-red-800 dark:text-red-400',
