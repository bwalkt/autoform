...
const TableHeader = React.forwardRef<HTMLTableSectionElement, TableHeaderProps>(({ className, ...props }, ref) => {
  ...
  return (
    <thead ref={ref} className={cn('[&_tr]:border-b', variant === 'surface' && 'bg-muted/50', className)} {...props} />
  )
})
...
const TableCell = React.forwardRef<HTMLTableCellElement, TableCellProps>(({ className, ...props }, ref) => {
  ...
  return (
    <td ref={ref} className={cn('align-middle [&:has([role=checkbox])]:pr-0', sizeConfig.cell, className)} {...props} />
  )
})
...
export interface TableRowHeaderCellProps extends React.ThHTMLAttributes<HTMLTableCellElement> {}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <th
        ref={ref}
        scope="row"
        className={cn('text-left align-middle font-medium', sizeConfig.cell, className)}
        {...props}
      />
    )
  },
...
export interface TableColumnHeaderCellProps extends React.ThHTMLAttributes<HTMLTableCellElement> {}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <th
        ref={ref}
        scope="col"
        className={cn('text-left align-middle font-semibold text-foreground', sizeConfig.header, className)}
        {...props}
      />
    )
  },
