  ...
  render: () => (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <Badge variant="outline" size="1">v2.0.0</Badge>
      </div>
      <div className="flex items-center gap-2">
        <span className="text-sm">Environment</span>
        <Badge color="info" variant="surface" size="1">Production</Badge>
      </div>
      <div className="p-4 border rounded-lg">
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-2">
            <Badge color="primary" variant="soft" size="1">Feature</Badge>
            <Badge color="warning" variant="soft" size="1">High Priority</Badge>
          </div>
        </div>
      </div>
    </div>
