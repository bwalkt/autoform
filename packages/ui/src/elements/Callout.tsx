...
const colorVariantStyles: Record<Color, Record<CalloutVariant, string>> = {
  ...
  neutral: {
    ...
    surface:
      'bg-gray-50 ring-1 ring-inset ring-gray-200 text-gray-700 dark:bg-gray-800/30 dark:ring-gray-700 dark:text-gray-300',
  ...
  info: {
    ...
    surface:
      'bg-blue-50 ring-1 ring-inset ring-blue-200 text-blue-700 dark:bg-blue-900/20 dark:ring-blue-800 dark:text-blue-400',
  ...
  success: {
    ...
    surface:
      'bg-green-50 ring-1 ring-inset ring-green-200 text-green-700 dark:bg-green-900/20 dark:ring-green-800 dark:text-green-400',
  ...
  warning: {
    ...
    surface:
      'bg-amber-50 ring-1 ring-inset ring-amber-200 text-amber-700 dark:bg-amber-900/20 dark:ring-amber-800 dark:text-amber-400',
  ...
  error: {
    ...
    surface:
      'bg-red-50 ring-1 ring-inset ring-red-200 text-red-700 dark:bg-red-900/20 dark:ring-red-800 dark:text-red-400',
...
const CalloutRoot = React.forwardRef<HTMLDivElement, CalloutRootProps>(
  (
    { className, size = '2', variant = 'soft', color = 'default', highContrast = false, style, children, ...props },
    ref,
  ) => {
...
const CalloutText = React.forwardRef<HTMLParagraphElement, CalloutTextProps>(({ className, ...props }, ref) => {
  ...
  return <p ref={ref} className={cn(textSizeStyles[size], 'leading-relaxed', className)} {...props} />
})
