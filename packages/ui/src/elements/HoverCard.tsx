...
const HoverCardRoot: React.FC<HoverCardRootProps> = ({ open, onOpenChange, defaultOpen, children }) => {
  return (
...
const HoverCardTrigger = React.forwardRef<HTMLButtonElement, HoverCardTriggerProps>(
  ({ children, className, ...props }, ref) => {
    return (
      <PopoverPrimitive.Trigger ref={ref} className={cn('outline-none', className)} {...props}>
        {children}
